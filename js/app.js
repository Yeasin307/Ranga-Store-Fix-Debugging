...
const updateTaxAndCharge = () => {
  ...
  if (priceConverted > 200) {
    ...
    totalTax.innerText = parseFloat(priceConverted * 0.2).toFixed(2);
    // setInnerText("total-tax", priceConverted * 0.2);
  }
  if (priceConverted > 400) {
    setInnerText("delivery-charge", 50);
    const totalTax = document.getElementById('total-tax');
    totalTax.innerText = parseFloat(priceConverted * 0.3).toFixed(2);
    // setInnerText("total-tax", priceConverted * 0.3);
  }
  if (priceConverted > 500) {
    setInnerText("delivery-charge", 60);
    const totalTax = document.getElementById('total-tax');
    totalTax.innerText = parseFloat(priceConverted * 0.4).toFixed(2);
